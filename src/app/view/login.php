    ...
    <div class="wapper">
        ...
        <main>
            <section class="login-section d-flex justify-content-center align-items-center text-center">
                <form action="<?php echo '/login'; ?>" method="post" style="width:350px">
                    ...
                    if (isset($_SESSION['login_fail']) && $_SESSION['login_fail']) {
                        echo '<div class="text-danger fw-bold mt-3">* tài khoản hoặc mật khẩu không chính xác</div>';
                    ...
                    <a class="text-muted" href="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . '/register'; ?>">Bạn chưa có tài khoản?</a>
                </form>
            </section>
        </main>
    </div>
